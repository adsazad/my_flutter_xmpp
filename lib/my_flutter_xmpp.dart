...
class FlutterXmpp {
  static const MethodChannel _channel = MethodChannel('my_flutter_xmpp/method');
  static const EventChannel _eventChannel =
      EventChannel('my_flutter_xmpp/stream');
  ...
  Future<String> sendMessage(String toJid, String body, String Id) async {
    var params = {"to_jid": toJid, "body": body, "id": Id};
